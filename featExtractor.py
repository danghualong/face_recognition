...
# 要读取人脸图像文件的路径
path_images_from_camera = "pic_data/"
...
def getAllFeatures():
    ...
    for person in people:
        ...
        print('\n')
        feats[person]=features_mean_personX
    return feats

def saveFeats(feats):
    df=pd.DataFrame(feats)
    df.to_csv("feature/features2_all.csv",mode='w',index=False)
    print("所有录入人脸数据存入 / Save all the features of faces registered into: ./feature/features_all2.csv")
